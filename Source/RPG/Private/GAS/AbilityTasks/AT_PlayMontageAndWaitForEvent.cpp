...
#include "GAS/AbilityTasks/AT_PlayMontageAndWaitForEvent.h"
	...
	float AnimRootMotionTranslationScale)
{
	...
	UAT_PlayMontageAndWaitForEvent* Obj = NewAbilityTask<UAT_PlayMontageAndWaitForEvent>(OwningAbility, TaskInstanceName);
